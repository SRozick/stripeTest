...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { description: @widget.description, name: @widget.name, picture: @widget.picture, price: @widget.price }
    end
  ...
  test "should update widget" do
    patch :update, id: @widget, widget: { description: @widget.description, name: @widget.name, picture: @widget.picture, price: @widget.price }
    assert_redirected_to widget_path(assigns(:widget))
  end
